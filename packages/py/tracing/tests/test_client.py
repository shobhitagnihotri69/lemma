...
# ---------------------------------------------------------------------------
# SpanHandle.end() – attribute and metadata merging
# ---------------------------------------------------------------------------
